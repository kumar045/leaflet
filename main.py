...
def simplify_text_with_gemini(text, metrics=None):
...
def main():
    ...
    if uploaded_file is not None:
        ...
        simplified_text = simplify_text_with_gemini(original_text)
        ...
        while not is_text_readable(metrics) and iteration < max_iterations:
            ...
            simplified_text = simplify_text_with_gemini(simplified_text, metrics)
            metrics = analyze_text(simplified_text)
            iteration += 1
