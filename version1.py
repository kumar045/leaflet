...
def simplify_text_with_gemini(text, api_key, metrics=None):
    ...
    try:
        ...
        try:
            ...
            if "Illegal metadata" in str(e):
                logger.error("This error might be caused by an invalid or expired API key.")
        ...
        logger.error(f"Error in simplify_text_with_gemini: {str(e)}")
